    ...
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          description: "!font-sans !text-[13px] !text-mid !leading-[1.55] !mt-1",
          actionButton: "!bg-foreground !text-background !rounded-none !font-mono !text-[10px] !tracking-[0.12em] !uppercase",
          cancelButton: "!bg-transparent !text-mid !rounded-none !font-mono !text-[10px] !tracking-[0.12em] !uppercase",
          closeButton: "!bg-transparent !border-rule !text-mid hover:!text-foreground !rounded-none",
